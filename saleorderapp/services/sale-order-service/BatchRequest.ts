...
/**
 * Batch builder for operations supported on the Sale Order Service.
 * @param requests The requests of the batch
 * @returns A request builder for batch.
 */
export function batch<DeSerializersT extends DeSerializers>(
  ...requests: Array<
    | ReadSaleOrderServiceRequestBuilder<DeSerializersT>
...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultSaleOrderServicePath,
    transformVariadicArgumentToArray(first, rest)
  );
}

/**
 * Change set constructor consists of write operations supported on the Sale Order Service.
 * @param requests The requests of the change set
 * @returns A change set for batch.
 */
export function changeset<DeSerializersT extends DeSerializers>(
  ...requests: Array<WriteSaleOrderServiceRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  requests: Array<WriteSaleOrderServiceRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteSaleOrderServiceRequestBuilder<DeSerializersT>
    | Array<WriteSaleOrderServiceRequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteSaleOrderServiceRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultSaleOrderServicePath =
  '/sap/opu/odata/sap/API_SALES_ORDER_SRV';
export type ReadSaleOrderServiceRequestBuilder<
...
> =
  ...
  | GetByKeyRequestBuilder<
      ...
      DeSerializersT
    >;
export type WriteSaleOrderServiceRequestBuilder<
  DeSerializersT extends DeSerializers
> =
