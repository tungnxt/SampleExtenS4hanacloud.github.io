...
import { RejectApprovalRequestParameters, ReleaseApprovalRequestParameters } from './operations';
import { BigNumber } from 'bignumber.js';
import { Moment } from 'moment';
import { DeSerializers, DefaultDeSerializers, Time } from '@sap-cloud-sdk/odata-v2';
import { batch, changeset } from './BatchRequest';
export declare function saleOrderService<BinaryT = string, BooleanT = boolean, ByteT = number, DecimalT = BigNumber, DoubleT = number, FloatT = number, Int16T = number, Int32T = number, Int64T = BigNumber, GuidT = string, SByteT = number, SingleT = number, StringT = string, AnyT = any, DateTimeOffsetT = Moment, DateTimeT = Moment, TimeT = Time>(deSerializers?: Partial<DeSerializers<BinaryT, BooleanT, ByteT, DecimalT, DoubleT, FloatT, Int16T, Int32T, Int64T, GuidT, SByteT, SingleT, StringT, AnyT, DateTimeOffsetT, DateTimeT, TimeT>>): SaleOrderService<DeSerializers<BinaryT, BooleanT, ByteT, DecimalT, DoubleT, FloatT, Int16T, Int32T, Int64T, GuidT, SByteT, SingleT, StringT, AnyT, DateTimeOffsetT, DateTimeT, TimeT>>;
declare class SaleOrderService<DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    private apis;
    ...
    get operations(): {
        rejectApprovalRequest: (parameter: RejectApprovalRequestParameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v2").OperationRequestBuilder<DeSerializersT, RejectApprovalRequestParameters<DeSerializersT>, import("./FunctionResult").FunctionResult<DefaultDeSerializers>>;
        releaseApprovalRequest: (parameter: ReleaseApprovalRequestParameters<DeSerializersT>) => import("@sap-cloud-sdk/odata-v2").OperationRequestBuilder<DeSerializersT, ReleaseApprovalRequestParameters<DeSerializersT>, import("./FunctionResult").FunctionResult<DefaultDeSerializers>>;
    };
