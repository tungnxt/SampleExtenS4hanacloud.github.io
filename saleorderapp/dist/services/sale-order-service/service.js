...
function saleOrderService(deSerializers = odata_v2_1.defaultDeSerializers) {
    return new SaleOrderService((0, odata_v2_1.mergeDefaultDeSerializersWith)(deSerializers));
}
